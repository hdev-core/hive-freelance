 ...
 * array). `budgetRange` maps to the real budget_min/budget_max filter
 * (JobsListPage does that mapping) — this component just picks a range.
 * No escrow-funded toggle: that was funding_status, which never had a real
 * backing field and was dropped rather than stubbed (see JobsListPage).
 */
